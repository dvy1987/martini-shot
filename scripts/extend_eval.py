...
SHOTS = [
    # shot-01-meadow trips Veo's third-party content filter (recorded in the
    # 2/3 run of 2026-09-04); replaced with a labeled synthetic gradient
    # scene (C-1.3) generated by ffmpeg `gradients` (command in evidence).
    ("synthetic-drift-01-720p.mp4", "Synthetic drift — chaser setup"),
    ("shot-02-grove-720p.mp4", "Grove pan — mid-scene"),
    ("shot-03-clearing-720p.mp4", "Clearing reveal — scene out"),
]
