...
**Open:** spec §7 amendment proposal (SSE envelope, FE auth, Replit mechanics) awaits owner approval. SSE url intentionally `null` until G1 — no mock API ever (C-1.2/A2).
