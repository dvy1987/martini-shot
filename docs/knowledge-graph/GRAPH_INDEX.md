...
**pr** (1): pr-authoring
**pre** (1): pre-mortem
**retroactive** (66): adversarial-hat, agent-builder, agent-loom-sync, apply-paper-to-project, architectural-decision-log, assumption-mapping, brainstorming, business-modeling, codebase-understanding, compress-skill
  … +56 more
**run** (1): run-trace
