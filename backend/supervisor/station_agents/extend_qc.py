...
def build_prompt(report: dict[str, Any]) -> str:
    ...
    return (
        ...
        "healthy drafts historically 0.0013-0.0032, a broken render is an "
        ...
        "Rules:\n"
        "1. Accept as draft when flicker is in the healthy band and the "
        "meter genuinely analyzed frames.\n"
